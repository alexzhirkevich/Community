...
import github.alexzhirkevich.community.core.repo.interfaces.ContactsRepository
import github.alexzhirkevich.community.core.repo.interfaces.FirebaseRepository
import github.alexzhirkevich.community.core.repo.interfaces.FirebaseRepository.Companion.COLLECTION_CONTACTS
...
class ContactsRepositoryImp @Inject constructor (
    ...
    private suspend fun clear() {
        try {
            ...
            Log.e(javaClass.simpleName,"Failed to delete collection",t)
        }
    }
}
